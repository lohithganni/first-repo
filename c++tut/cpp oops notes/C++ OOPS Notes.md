...
public:
    ...
    // Const member function that doesn't modify the object's state
    void printX() const {
        std::cout << "Value of x: " << x << std::endl;
    }

    // Non-const member function that modifies the object's state
    void setX(int val) {
        x = val;
    }
};
...
int main() {
    ...
    obj.printX(); // Calling const member function

    // obj.setX(10); // This line would cause a compilation error because obj is const
